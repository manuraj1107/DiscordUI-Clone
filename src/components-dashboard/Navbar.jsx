...
const Navbar = () => {
  return (
    <div className='flex text-white h-12'>
          <div className='bg-[#2F3136] w-56 flex-none flex items-center justify-between border-b border-gray-900 px-3 py-2'>
          ...
          <div  className='flex-1 bg-[#36393e] flex items-center justify-between border-b border-gray-800 px-4'>
          <div className='flex items-center'>
            <div className='text-gray-500 text-3xl font-semibold'>#</div>
            <div className='ml-2 text-md font-semibold text-white'>general</div>
            
          </div>
          <div className='flex items-center'>
          <a href="#" className="ml-4">
              <svg className="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z"></path></svg>
            </a>
            <a href="#" className="ml-4">
              <svg className="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" viewBox="0 0 24 24"><path className="secondary" d="M2.24 20.35l6.5-7.5a1 1 0 0 1 1.47-.06l1 1a1 1 0 0 1-.06 1.47l-7.5 6.5c-.93.8-2.22-.48-1.4-1.41z"></path><path className="primary" d="M15 15.41V18a1 1 0 0 1-.3.7l-1 1a1 1 0 0 1-1.4 0l-8-8a1 1 0 0 1 0-1.4l1-1A1 1 0 0 1 6 9h2.59L13 4.59V3a1 1 0 0 1 1.7-.7l7 7A1 1 0 0 1 21 11h-1.59L15 15.41z"></path></svg>
            </a>
            <a href="#" className="ml-4">
            ...
            <a href="#" className="ml-4">
              ...
              <input type='text' placeholder='Search' className='rounded bg-gray-900 text-gray-200 text-xs px-2 py-1' />
              <span className='absolute right-0 top-0 mr-1 py-2'>
